...
describe('calendar helpers', () => {
  ...
  it('detects maintenance via isDuringMaintenance', () => {
    ...
    expect(isDuringMaintenance(DateTime.fromISO('2024-01-01T09:30:00Z', { zone: 'utc' }), mw)).toBe(
      true,
    );
    expect(isDuringMaintenance(DateTime.fromISO('2024-01-01T10:00:00Z', { zone: 'utc' }), mw)).toBe(
      false,
    );
  });
